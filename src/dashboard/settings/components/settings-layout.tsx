        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-1/4">
            <TabsList className="flex flex-col h-auto p-0 bg-transparent space-y-1">
              ...
              <TabsTrigger value="preferences" className="justify-start px-4 py-2 h-9 data-[state=active]:bg-muted">
                <Globe className="h-4 w-4 mr-2" />
                Preferences
              </TabsTrigger>
             
              <Separator className="my-4" />
              <Button variant="ghost" className="justify-start px-4 h-9 font-normal text-red-600">
